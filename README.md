...
# Atividade 6 - Criar endpoint para consumir dados de uma webservice SOAP

Link do wsl utilizado, que contêm métodos de uma calculadora básica: http://www.dneonline.com/calculator.asmx?wsdl

Adiciona dependência para consumir dados de um webservice SOAP:
```
pip install zeep
```

Cria-se o arquivo de rotas views_calculadora.py:

```python
# api/views_calculadora.py
from ninja import Router
